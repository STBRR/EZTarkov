...
class Mod {
    constructor() {
        this.modConfig = require("..//config.json"); //this grabs our config file I think
    }
    postDBLoad(container) {
        const Logger = container.resolve("WinstonLogger");
        Logger.info("Running Fershte's Balance Patch!");
        ...
        if (this.modConfig.optics) {
            ...
            //Optics
            {
                //30mm
                {
                    let modErgo = "-4"; //gonna delete mount penalties, so this is higher than the 'bis'
                ...
                //KMZ
                {
                    let modErgo = "-4"; //the sum when u use teh mount and the eyecup
        ...
        //Stonks
        if (this.modConfig.stocks) {
            Logger.info(`Balancing: Stocks`);
            {
                //AKs
                {
                    //AK-100 buff:
                    //RPK-16 buffer tube (RPK-16 tube)
                    items["5beec8b20db834001961942a"]._props.Recoil = "-6",
                        //AK Zenit PT-1 "Klassika" stock (PT-1)
                        items["5b222d405acfc400153af4fe"]._props.Recoil = "-38",
                        items["5b222d405acfc400153af4fe"]._props.Ergonomics = "25",
                        ...
                        items["6087e2a5232e5a31c233d552"]._props.Recoil = "-41",
                        items["6087e2a5232e5a31c233d552"]._props.Ergonomics = "14",
                        //AKM/AK-74 Magpul Zhukov-S stock (Zhukov-S AK)	
                        items["5b0e794b5acfc47a877359b2"]._props.Recoil = "-40",
                        items["5b0e794b5acfc47a877359b2"]._props.Ergonomics = "20",
        ...
        if (this.modConfig.muzzleDevices) {
        ...
        if (this.modConfig.experimental) {
            Logger.info(`Doing Fershte's Experiments`);
        }
        if (this.modConfig.compatibility) {
            ...
            for (let BarrelID of ArrOf308Barrels) {
                for (let MuzzleID of ArrOf308MuzzleDevices) {
                    if (!items[BarrelID]._props.Slots[0]._props.filters[0].Filter.includes(MuzzleID)) {
                        items[BarrelID]._props.Slots[0]._props.filters[0].Filter.push(MuzzleID);
                    }
            ...
            for (let BarrelID of ArrOfOmega45Barrels) {
                if (!items[BarrelID]._props.Slots[0]._props.filters[0].Filter.includes("5fc4b992187fea44d52edaa9")) {
                    items[BarrelID]._props.Slots[0]._props.filters[0].Filter.push("5fc4b992187fea44d52edaa9");
                }
                if (!items[BarrelID]._props.Slots[0]._props.filters[0].Filter.includes("59bffc1f86f77435b128b872")) {
                    items[BarrelID]._props.Slots[0]._props.filters[0].Filter.push("59bffc1f86f77435b128b872");
                }
            }
        }
    }
