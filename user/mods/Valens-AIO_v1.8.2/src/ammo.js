...
class Ammo {
    constructor(logger, databaseServer) {
        this.modConfig = require("../config/ammo.json");
        this.logger = logger;
    ...
    updateAmmo() {
        ...
        if (stacks.grenades != 1) {
            for (const value of Object.values(AmmoTypes_1.Grenade)) {
        ...
        if (stacks.a86x70 != 30) {
            for (const value of Object.values(AmmoTypes_1.Ammo86x70)) {
        ...
        if (stacks.a127x55 != 30) {
            for (const value of Object.values(AmmoTypes_1.Ammo127x55)) {
        ...
        if (stacks.a762x54 != 40) {
            for (const value of Object.values(AmmoTypes_1.Ammo762x54)) {
        ...
        if (stacks.a762x51 != 40) {
            for (const value of Object.values(AmmoTypes_1.Ammo762x51)) {
        ...
        if (stacks.a9x39 != 50) {
            for (const value of Object.values(AmmoTypes_1.Ammo9x39)) {
        ...
        if (stacks.a366TKM != 50) {
            for (const value of Object.values(AmmoTypes_1.Ammo366TKM)) {
        ...
        if (stacks.a762x39 != 60) {
            for (const value of Object.values(AmmoTypes_1.Ammo762x39)) {
        ...
        if (stacks.a762x35 != 60) {
            for (const value of Object.values(AmmoTypes_1.Ammo762x35)) {
        ...
        if (stacks.a556x45 != 60) {
            for (const value of Object.values(AmmoTypes_1.Ammo556x45)) {
        ...
        if (stacks.a545x39 != 60) {
            for (const value of Object.values(AmmoTypes_1.Ammo545x39)) {
        ...
        if (stacks.a57x28 != 60) {
            for (const value of Object.values(AmmoTypes_1.Ammo57x28)) {
        ...
        if (stacks.a46x30 != 70) {
            for (const value of Object.values(AmmoTypes_1.Ammo46x30)) {
        ...
        if (stacks.a9x33R != 30) {
            for (const value of Object.values(AmmoTypes_1.Ammo9x33R)) {
        ...
        if (stacks.a1143x23ACP != 50) {
            for (const value of Object.values(AmmoTypes_1.Ammo1143x23ACP)) {
        ...
        if (stacks.a762x25 != 50) {
            for (const value of Object.values(AmmoTypes_1.Ammo762x25)) {
        ...
        if (stacks.a9x21 != 50) {
            for (const value of Object.values(AmmoTypes_1.Ammo9x21)) {
        ...
        if (stacks.a9x19 != 50) {
            for (const value of Object.values(AmmoTypes_1.Ammo9x19)) {
        ...
        if (stacks.a9x18 != 50) {
            for (const value of Object.values(AmmoTypes_1.Ammo9x18)) {
        ...
        if (stacks.a23x75 != 15) {
            for (const value of Object.values(AmmoTypes_1.Ammo23x75)) {
        ...
        if (stacks.a12Gauge != 20) {
            for (const value of Object.values(AmmoTypes_1.Ammo12Gauge)) {
        ...
        if (stacks.a20Gauge != 20) {
            for (const value of Object.values(AmmoTypes_1.Ammo20Gauge)) {
        ...
        if (stacks.a30x29 != 1) {
            for (const value of Object.values(AmmoTypes_1.Ammo30x29)) {
        ...
        if (stacks.a26x75 != 1) {
            for (const value of Object.values(AmmoTypes_1.Ammo26x75)) {
        ...
        if (zero.g127x55 != "5cadf6ddae9215051e1c23b2") {
            for (const value of Object.values(WeaponTypes_1.Weapons127x55)) {
        ...
        if (zero.g86x70 != "5fc275cf85fd526b824a571a") {
            for (const value of Object.values(WeaponTypes_1.Weapons86x70)) {
        ...
        if (zero.g762x54 != "5887431f2459777e1612938f") {
            for (const value of Object.values(WeaponTypes_1.Weapons762x54R)) {
        ...
        if (zero.g762x51 != "58dd3ad986f77403051cba8f") {
            for (const value of Object.values(WeaponTypes_1.Weapons762x51)) {
        ...
        if (zero.g9x39 != "57a0dfb82459774d3078b56c") {
            for (const value of Object.values(WeaponTypes_1.Weapons9x39)) {
        ...
        if (zero.g366TKM != "59e655cb86f77411dc52a77b") {
            for (const value of Object.values(WeaponTypes_1.Weapons366TKM)) {
        ...
        if (zero.g762x39 != "5656d7c34bdc2d9d198b4587") {
            for (const value of Object.values(WeaponTypes_1.Weapons762x39)) {
        ...
        if (zero.g762x35 != "5fbe3ffdf8b6a877a729ea82") {
            for (const value of Object.values(WeaponTypes_1.Weapons762x35)) {
        ...
        if (zero.g556x45 != "54527a984bdc2d4e668b4567") {
            for (const value of Object.values(WeaponTypes_1.Weapons556x45)) {
        ...
        if (zero.g545x39 != "56dff3afd2720bba668b4567") {
            for (const value of Object.values(WeaponTypes_1.Weapons545x39)) {
        ...
        if (zero.g57x28 != "5cc80f38e4a949001152b560") {
            for (const value of Object.values(WeaponTypes_1.Weapons57x28FN)) {
        ...
        if (zero.g46x30 != "5ba2678ad4351e44f824b344") {
            for (const value of Object.values(WeaponTypes_1.Weapons46x30HK)) {
        ...
        if (zero.g9x33R != "62330b3ed4dc74626d570b95") {
            for (const value of Object.values(WeaponTypes_1.Weapons9x33R)) {
        ...
        if (zero.g1143x23ACP != "5e81f423763d9f754677bf2e") {
            for (const value of Object.values(WeaponTypes_1.Weapons1143x23)) {
        ...
        if (zero.g762x25 != "5736026a245977644601dc61") {
            for (const value of Object.values(WeaponTypes_1.Weapons762x25)) {
        ...
        if (zero.g12Gauge != "560d5e524bdc2d25448b4571") {
            for (const value of Object.values(WeaponTypes_1.Weapons12Gauge)) {
        ...
        if (zero.g20Gauge != "5a38ebd9c4a282000d722a5b") {
            for (const value of Object.values(WeaponTypes_1.Weapons20Gauge)) {
